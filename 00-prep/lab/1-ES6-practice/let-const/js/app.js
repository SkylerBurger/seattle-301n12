...
function displayPics(){
  ...
  // Since let is block scoped, rando is only scoped to work within the outer while loop in the displayPics function aove. When we try to call it outside of the loop it is no longer available.
